/*
Discord bot script for insert an object to the Collection
...
var urldb = "mongodb+srv://YOUR_USERNAME:YOUR_PASSWORD@*********.*********.mongodb.net/test" // Paste your MongoDB link here
    MongoClient.connect(urldb, { useNewUrlParser: true, useUnifiedTopology: true }, function (err, db) {
        ...
        database.collection("COLLECTION_NAME").insertOne({id:"1234", username:"Test", your_parameter:"insert a number or a text"}) // Insert a new object
